...
class settings(QStackedWindowItem):
	...
	def __initScreen__(self):
		...
		self.tblGrid.setCellWidget(1,0,self.chkBeSe)
		self.chkOrSd=QCheckBox(i18n["SDDM_ORCA"])
		self.tblGrid.setCellWidget(1,1,self.chkOrSd)
		self.chkMono=QCheckBox(i18n["MONO"])
		self.tblGrid.setCellWidget(2,0,self.chkMono)
		...
		self.tblGrid.setCellWidget(4,0,self.chkAuDo)
